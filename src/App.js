  ...
  return (
    <div className="App">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        />
        <h1 style={{ flex: 1, textAlign: 'center', marginTop: '-150px' }}>Solar Site Viability Assessment Tool (Prototype)</h1>
        <img
          src={companyLogo}
          alt="Company Logo"
      ...
      {currentPage === 1 && (
        <div>
          <p className="solar-safe-text" style={{ marginTop: '-150px' }}>SolarSafe</p>
